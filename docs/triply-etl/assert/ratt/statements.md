...
When Signature 2 is used, the nested node must be specified by the user. This allows the nested node to be created in a more structured way, for example by using [iri()](./terms.md#iri-function), [addIri()](../../transform/ratt.md#addiri), or [addHashedIri()](../../transform/ratt.md#addhashediri).
