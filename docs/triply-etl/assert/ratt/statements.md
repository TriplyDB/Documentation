...
Since linked data is composed of triples, more complex n-ary information must often be asserted by using a nested node. Nested nodes must be IRIs, so they must be specified with [iri()](./terms.md#function-iri) or [addIri()](../../transform/ratt.md#function-addiri).

Signature: `nestedPairs(subject, predicate, nestedNode, pairs...)`

### Parameters

- `subject` A subject term. This must be an IRI (see function [iri()](./terms.md#function-iri)).
- `predicate` A predicate term. This must be an IRI (see function [iri()](./terms.md#function-iri)).
- `nestedNode` The nested node. This must be an IRI (see function [iri()](./terms.md#function-iri)).
...
- Use transformation [addHashedIri()](../../transform/ratt.md#function-addhashediri) to create a content-based IRI.
- Use transformation [addRandomIri()](../../transform/ratt.md#function-addrandomiri) to create a random IRI.
- Use transformation [addSkolemIri()](../../transform/ratt.md#function-addskolemiri) to create a random Skolem IRI.
...
- `subject` A subject term. This must be either an IRI (see function [iri()](./terms.md#function-iri)) or a literal (see function [literal()](./terms.md#function-literal)).
- `predicate` A predicate term. This must be an IRI (see function [iri()](./terms.md#function-iri)).
- `objects` An array of object terms. This must be either an IRI (see function [iri()](./terms.md#function-iri)) or a literal (see function [literal](./terms.md#function-literal)). Every distinct object term in the array results in a distinct triple assertion.
...
- `subject` A subject term. This must be an IRI (see function [iri()](./terms.md#function-iri)).
- `predicate` A predicate term. This must be an IRI (see function [iri()](./terms.md#function-iri)).
- `object` An object term. This must be either an IRI (see function [iri()](./terms.md#function-iri)) or a literal (see function [literal()](./terms.md#function-literal)).
- `graph` A graph name. This must be an IRI (see function [iri()](./terms.md#function-iri)).
...
- the subject term is an IRI that is stored in the `'_person'` key of the record (possibly created with transformation function [addIri()](../../transform/ratt.md#function-addiri)),
...
Since literals with datatype IRI `xsd:string` are very common, statement assertions allow such literals to be specified without using [`literal()`](./terms.md#function-literal).
