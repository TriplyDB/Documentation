...
<!-- SOURCE: triply-db-getting-started/data-stories/index.md — "Sharing and embedding",
...
![The dialog for embedding a data story](../../../assets/data-stories-embed.png)

The embed is live, not a copy — when the underlying data changes, the embedded story changes with
it.
