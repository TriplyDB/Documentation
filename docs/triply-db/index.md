...
In this case the downloaded file "https___data.netwerkdigitaalerfgoed.nl_hackalod_gvn_pkl01.trig" is named after the graph and also compressed with "gz".
...
Select the file that should be extracted. In this case select "Translations.trig" and click on "Extract". In the following step choose the location where the extracted file should be stored.
