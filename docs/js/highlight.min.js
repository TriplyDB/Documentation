/*!
  Highlight.js v11.9.0 (git: 2a4acf40ca)
...
contains:[v]},k=(e,n,t={})=>{const i=a({scope:"comment",begin:e,end:n,
...
return n?Number(n):(e=>z.includes(e.toLowerCase()))(e)?0:1}const j={},K=e=>{
...
r.__beforeBegin=null,[I,D,B].forEach((e=>e(r,s))),r.isCompiled=!0;let l=null
...
;return s.code=r.code,k("after:highlight",s),s}function f(e,t,i,r){
const l=Object.create(null);function c(){if(!k.keywords)return void S.addText(A)
...
A=""):e.beginScope._multi&&(u(e.beginScope,n),A="")),k=Object.create(e,{parent:{
value:k}}),k}function m(e,t,a){let i=((e,n)=>{const t=e&&e.exec(n)
;return t&&0===t.index})(e.endRe,a);if(i){if(e["on:end"]){const a=new n(e)
;e["on:end"](t,a),a.isMatchIgnored&&(i=!1)}if(i){
for(;e.endsParent&&e.parent;)e=e.parent;return e}}
if(e.endsWithParent)return m(e.parent,t,a)}function _(e){
return 0===k.matcher.regexIndex?(A+=e[0],1):(I=!0,0)}function h(e){
const n=e[0],a=t.substring(e.index),i=m(k,e,a);if(!i)return ee;const r=k
;k.endScope&&k.endScope._wrap?(d(),
g(n,k.endScope._wrap)):k.endScope&&k.endScope._multi?(d(),
u(k.endScope,e)):r.skip?A+=n:(r.returnEnd||r.excludeEnd||(A+=n),
d(),r.excludeEnd&&(A=n));do{
k.scope&&S.closeNode(),k.skip||k.subLanguage||(C+=k.relevance),k=k.parent
}while(k!==i.parent);return i.starts&&b(i.starts,e),r.returnEnd?0:n.length}
...
;throw e.mode=k,e}if("end"===r.type){const e=h(r);if(e!==ee)return e}
if("illegal"===r.type&&""===o)return 1
;if(R>1e5&&R>3*r.index)throw Error("potential infinite loop, way more iterations than matches")
;return A+=o,o.length}const w=v(e)
;if(!w)throw K(o.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const O=Q(w);let x="",k=r||O;const M={},S=new p.__emitter(p);(()=>{const e=[]
;for(let n=k;n!==w;n=n.parent)n.scope&&e.unshift(n.scope)
;e.forEach((e=>S.openNode(e)))})();let A="",C=0,T=0,R=0,I=!1;try{
if(w.__emitTokens)w.__emitTokens(t,S);else{for(k.matcher.considerAll();;){
R++,I?I=!1:k.matcher.considerAll(),k.matcher.lastIndex=T
;const e=k.matcher.exec(t);if(!e)break;const n=N(t.substring(T,e.index),e)
;T=e.index+n}N(t.substring(T))}return S.finalize(),x=S.toHTML(),{language:e,
value:x,relevance:C,illegal:!1,_emitter:S,_top:k}}catch(n){
if(n.message&&n.message.includes("Illegal"))return{language:e,value:J(t),
illegal:!0,relevance:0,_illegalBy:{message:n.message,index:T,
context:t.slice(T-100,T+100),mode:n.mode,resultSoFar:x},_emitter:S};if(s)return{
language:e,value:J(t),illegal:!1,relevance:0,errorRaised:n,_emitter:S,_top:k}
...
}),k("after:highlightElement",{el:e,result:r,text:a})}let N=!1;function w(){
...
className:"variable.constant"},E,x,{match:/\$[(.]/}]}}function xe(e){const n={
keyword:"base|10 prefix|10 @base|10 @prefix|10",literal:"true|0 false|0",
built_in:"a|0"},t={className:"literal",relevance:1,begin:/</,end:/>/,
illegal:/[^\x00-\x20<>"{}|^`]/
},a="A-Za-z\xc0-\xd6\xd8-\xf6\xf8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c-\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd\u10000-\uefffF",i=a+"_",r="-"+i+"0-9\xb7\u0300-\u036f\u203f-\u2040",s="%[0-9A-Fa-f][0-9A-Fa-f]|\\\\[_~.!$&'()*+,;=/?#@%-]",o="(["+a+"](["+r+".]*["+r+"])?)?:",l="(["+i+":0-9]|"+s+")(["+r+".:]|"+s+")*(["+r+":]|"+s+")?",c={
begin:o+"("+l+")?",relevance:0,className:"symbol"},d={
begin:"_:["+i+"0-9](["+r+".]*["+r+"])?",relevance:10,
className:"template-variable"},g={begin:/@[a-zA-Z]+([a-zA-Z0-9-]+)*/,
className:"type",relevance:5},u={begin:"\\^\\^"+(o+l),className:"type",
relevance:10},b={begin:/'''/,end:/'''/,className:"string",relevance:0},m={
begin:/"""/,end:/"""/,className:"string",relevance:0
},p=JSON.parse(JSON.stringify(e.APOS_STRING_MODE));p.relevance=0
;const _=JSON.parse(JSON.stringify(e.QUOTE_STRING_MODE));_.relevance=0
;const h=JSON.parse(JSON.stringify(e.C_NUMBER_MODE));return h.relevance=0,{
case_insensitive:!0,keywords:n,name:"Turtle",
aliases:["turtle","ttl","n3","ntriples"],
contains:[g,u,t,d,c,b,m,p,_,h,e.HASH_COMMENT_MODE],exports:{LANGTAG:g,
DATATYPE:u,IRI_LITERAL:t,BLANK_NODE:d,PNAME:c,TRIPLE_APOS_STRING:b,
TRIPLE_QUOTE_STRING:m,APOS_STRING_LITERAL:p,QUOTE_STRING_LITERAL:_,NUMBER:h,
KEYWORDS:n}}}
const ke=e=>b(/\b/,e,/\w$/.test(e)?/\b/:/\B/),Me=["Protocol","Type"].map(ke),Se=["init","self"].map(ke),Ae=["Any","Self"],Ce=["actor","any","associatedtype","async","await",/as\?/,/as!/,"as","borrowing","break","case","catch","class","consume","consuming","continue","convenience","copy","default","defer","deinit","didSet","distributed","do","dynamic","each","else","enum","extension","fallthrough",/fileprivate\(set\)/,"fileprivate","final","for","func","get","guard","if","import","indirect","infix",/init\?/,/init!/,"inout",/internal\(set\)/,"internal","in","is","isolated","nonisolated","lazy","let","macro","mutating","nonmutating",/open\(set\)/,"open","operator","optional","override","postfix","precedencegroup","prefix",/private\(set\)/,"private","protocol",/public\(set\)/,"public","repeat","required","rethrows","return","set","some","static","struct","subscript","super","switch","throws","throw",/try\?/,/try!/,"try","typealias",/unowned\(safe\)/,/unowned\(unsafe\)/,"unowned","var","weak","where","while","willSet"],Te=["false","nil","true"],Re=["assignment","associativity","higherThan","left","lowerThan","none","right"],Ie=["#colorLiteral","#column","#dsohandle","#else","#elseif","#endif","#error","#file","#fileID","#fileLiteral","#filePath","#function","#if","#imageLiteral","#keyPath","#line","#selector","#sourceLocation","#warning"],De=["abs","all","any","assert","assertionFailure","debugPrint","dump","fatalError","getVaList","isKnownUniquelyReferenced","max","min","numericCast","pointwiseMax","pointwiseMin","precondition","preconditionFailure","print","readLine","repeatElement","sequence","stride","swap","swift_unboxFromSwiftValueWithType","transcode","type","unsafeBitCast","unsafeDowncast","withExtendedLifetime","withUnsafeMutablePointer","withUnsafePointer","withVaList","withoutActuallyEscaping","zip"],Le=m(/[/=\-+!*%<>&|^~?]/,/[\u00A1-\u00A7]/,/[\u00A9\u00AB]/,/[\u00AC\u00AE]/,/[\u00B0\u00B1]/,/[\u00B6\u00BB\u00BF\u00D7\u00F7]/,/[\u2016-\u2017]/,/[\u2020-\u2027]/,/[\u2030-\u203E]/,/[\u2041-\u2053]/,/[\u2055-\u205E]/,/[\u2190-\u23FF]/,/[\u2500-\u2775]/,/[\u2794-\u2BFF]/,/[\u2E00-\u2E7F]/,/[\u3001-\u3003]/,/[\u3008-\u3020]/,/[\u3030]/),Be=m(Le,/[\u0300-\u036F]/,/[\u1DC0-\u1DFF]/,/[\u20D0-\u20FF]/,/[\uFE00-\uFE0F]/,/[\uFE20-\uFE2F]/),$e=b(Le,Be,"*"),ze=m(/[a-zA-Z_]/,/[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/,/[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/,/[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/,/[\u1E00-\u1FFF]/,/[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/,/[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/,/[\u2C00-\u2DFF\u2E80-\u2FFF]/,/[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/,/[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/,/[\uFE47-\uFEFE\uFF00-\uFFFD]/),Fe=m(ze,/\d/,/[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),Ue=b(ze,Fe,"*"),Pe=b(/[A-Z]/,Fe,"*"),je=["attached","autoclosure",b(/convention\(/,m("swift","block","c"),/\)/),"discardableResult","dynamicCallable","dynamicMemberLookup","escaping","freestanding","frozen","GKInspectable","IBAction","IBDesignable","IBInspectable","IBOutlet","IBSegueAction","inlinable","main","nonobjc","NSApplicationMain","NSCopying","NSManaged",b(/objc\(/,Ue,/\)/),"objc","objcMembers","propertyWrapper","requires_stored_property_inits","resultBuilder","Sendable","testable","UIApplicationMain","unchecked","unknown","usableFromInline","warn_unqualified_access"],Ke=["iOS","iOSApplicationExtension","macOS","macOSApplicationExtension","macCatalyst","macCatalystApplicationExtension","watchOS","watchOSApplicationExtension","tvOS","tvOSApplicationExtension","swift"]
;var He=Object.freeze({__proto__:null,grmr_bash:e=>{const n=e.regex,t={},a={
...
subLanguage:"bash"}}]}),grmr_sparql:e=>{const n=xe(e).exports,t={
className:"variable",begin:"[?$]"+e.IDENT_RE,relevance:0};return{
case_insensitive:!0,name:"SPARQL",keywords:{
...
contains:[n.LANGTAG,n.DATATYPE,n.IRI_LITERAL,n.BLANK_NODE,n.PNAME,t,{
...
},n.TRIPLE_QUOTE_STRING,n.TRIPLE_APOS_STRING,n.QUOTE_STRING_LITERAL,n.APOS_STRING_LITERAL,n.NUMBER,e.HASH_COMMENT_MODE]
}},grmr_sql:e=>{
...
match:[/\./,m(...Me,...Se)],className:{2:"keyword"}},r={match:b(/\./,m(...Ce)),
relevance:0},s=Ce.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:m(...Ce.filter((e=>"string"!=typeof e)).concat(Ae).map(ke),...Se)}]},l={
$pattern:m(/\b\w+/,/#\w+/),keyword:s.concat(Ie),literal:Te},c=[i,r,o],g=[{
match:b(/\./,m(...De)),relevance:0},{className:"built_in",
match:b(/\b/,m(...De),/(?=\()/)}],u={match:/->/,relevance:0},p=[u,{
className:"operator",relevance:0,variants:[{match:$e},{match:`\\.(\\.|${Be})+`}]
...
scope:"regexp",variants:[M("###"),M("##"),M("#"),k]},A={match:b(/`/,Ue,/`/)
},C=[A,{className:"variable",match:/\$\d+/},{className:"variable",
match:`\\$${Fe}+`}],T=[{match:/(@|#(un)?)available/,scope:"keyword",starts:{
contains:[{begin:/\(/,end:/\)/,keywords:Ke,contains:[...p,f,O]}]}},{
scope:"keyword",match:b(/@/,m(...je))},{scope:"meta",match:b(/@/,Ue)}],R={
match:d(/\b[A-Z]/),relevance:0,contains:[{className:"type",
match:b(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/,Fe,"+")
},{className:"type",match:Pe,relevance:0},{match:/[?!]+/,relevance:0},{
match:/\.\.\./,relevance:0},{match:b(/\s+&\s+/,d(Pe)),relevance:0}]},I={
begin:/</,end:/>/,keywords:l,contains:[...a,...c,...T,u,R]};R.contains.push(I)
;const D={begin:/\(/,end:/\)/,relevance:0,keywords:l,contains:["self",{
match:b(Ue,/\s*:/),keywords:"_|0",relevance:0
},...a,S,...c,...g,...p,f,O,...C,...T,R]},L={begin:/</,end:/>/,
keywords:"repeat each",contains:[...a,R]},B={begin:/\(/,end:/\)/,keywords:l,
contains:[{begin:m(d(b(Ue,/\s*:/)),d(b(Ue,/\s+/,Ue,/\s*:/))),end:/:/,
relevance:0,contains:[{className:"keyword",match:/\b_\b/},{className:"params",
match:Ue}]},...a,...c,...p,f,O,...T,R,D],endsParent:!0,illegal:/["']/},$={
match:[/(func|macro)/,/\s+/,m(A.match,Ue,$e)],className:{1:"keyword",
3:"title.function"},contains:[L,B,n],illegal:[/\[/,/%/]},z={
match:[/\b(?:subscript|init[?!]?)/,/\s*(?=[<(])/],className:{1:"keyword"},
contains:[L,B,n],illegal:/\[|%/},F={match:[/operator/,/\s+/,$e],className:{
1:"keyword",3:"title"}},U={begin:[/precedencegroup/,/\s+/,Pe],className:{
1:"keyword",3:"title"},contains:[R],keywords:[...Re,...Te],end:/}/}
...
},S,...c,...g,...p,f,O,...C,...T,R,D]}},grmr_turtle:xe,grmr_typescript:e=>{
...
aliases:["yml"],contains:l}}});const qe=ae;for(const e of Object.keys(He)){
const n=e.replace("grmr_","").replace("_","-");qe.registerLanguage(n,He[e])}
return qe}()
