...
![The 'construct' part of the query](construct1.png)

In this part we can also add our own information, like a more detailed description or links.

![Continuation of the 'construct' part of the query](construct2.png)
...
![The 'where' part of the query](where.png)
...
![IIIF Viewer with an image displayed through Triply API](mirador-iris.png)
